...
export function ShareResult({ gameName, score }: Props) {
  ...
  return (
    <button
      type="button"
      onClick={handleShare}
      className="inline-flex items-center gap-2 rounded-lg border border-white/20 bg-white/5 px-4 py-2 text-sm font-medium transition-colors hover:bg-white/10"
    >
