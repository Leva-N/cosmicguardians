            ...
            <>
              {user ? (
                ...
                <Link
                  ...
                  className="hidden md:inline-flex items-center gap-1.5 rounded-xl bg-[#8A2BE2] px-3 py-2 text-xs font-semibold text-white transition-all hover:bg-[#9B4DE8] hover:text-white border-0 shadow-none outline-none focus:outline-none focus:ring-0"
                >
